...
<style>
    ...
    .hero {
        ...
        border-radius: 25px;
        background: linear-gradient(135deg, #7a1f2b, #b84c5a);
        color: white;
        text-align: center;
        margin-bottom: 2rem;
    }
...
with st.sidebar:
    ...
    st.write(
        "This application uses a YOLO-based image "
        "classification model trained to recognize "
        "traditional Bahraini foods."
    )
...
<h1>🇧🇭 Bahraini Food AI</h1>

<p>
Discover the Bahraini dish in your photo using Artificial Intelligence
</p>
...
st.write(
    "Upload a clear photo of a Bahraini food item and "
